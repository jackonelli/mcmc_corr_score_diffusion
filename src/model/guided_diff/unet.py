...
from src.model.guided_diff.fp16_util import convert_module_to_f16, convert_module_to_f32

# from src.model.guided_diff import dist_util
from src.model.guided_diff.nn import (
    checkpoint,
    conv_nd,
    linear,
    avg_pool_nd,
...
def parse_channel_mult(channel_mult: Optional[str], image_size: int):
    if channel_mult is None:
        if image_size == 512:
            parsed_channel_mult = (0.5, 1, 1, 2, 2, 4, 4)
        elif image_size == 256:
            parsed_channel_mult = (1, 1, 2, 2, 4, 4)
        elif image_size == 128:
        ...
        parsed_channel_mult = tuple(int(ch_mult) for ch_mult in channel_mult.split(","))
    return parsed_channel_mult
