...
from src.diffusion.beta_schedules import improved_beta_schedule, new_sparse, respaced_timesteps
...
def main():
    ...
    if batch_size < num_samples:
        ...
        guided_sampler = MCMCGuidanceSamplerStacking(diff_model=uncond_diff, diff_proc=diff_sampler, guidance=guidance,
                                                     mcmc_sampler=sampler)
        samples, _ = guided_sampler.sample_stacking(num_samples, batch_size, classes, device, th.Size((1, 28, 28)))
    else:
